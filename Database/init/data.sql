...
VALUES (1, N'Geschlecht', 1),
       (2, N'Familienstand', 1),
       (3, N'Anzahl Kinder', 1),
       (4, N'Was ist Ihr Höchster Abschluss?', 1),
       (5, N'Welcher Berufsgruppe gehören Sie an?', 1),
       (6, N'Bitte geben Sie Ihr monatliches Bruttoeinkommen an', 4),
       (7, N'In welchem Umfeld wurden Sie auf das Thema Rente aufmerksam gemacht?', 2),
       (8, N'In wieweit hat das Thema Rente Einfluss auf Ihre Familienplanung?', 1),
       (9, N'Was glauben Sie wird das Renteneintrittsalter sein wenn Sie in Rente gehen?', 4),
       ...
       (14,
        ...
        2),
       (15, N'Wie ausschlaggebend war die betriebliche Rente oder Möglichkeiten zu vermögenswirksamen Leistungen o.Ä. für die Wah Ihres Arbeitgebers?', 1),
       (16,
...
-- 6 Bruttoeinkommen
       ...
       (6, N'520 - 999 €', 2, 'span'),
       (6, N'1000 - 1499 €', 3, 'span'),
       (6, N'1500 - 1999 €', 4, 'span'),
       (6, N'2000 - 2999 €', 5, 'span'),
       (6, N'3000 - 3999 €', 6, 'span'),
       (6, N'4000 - 4999 €', 7, 'span'),
       (6, N'5000 - 5999 €', 8, 'span'),
       (6, N'Mehr als 6000 €', 9, 'span'),
-- 7
...
-- 14 Rentenpunkte Standardrente Demografischer Wandel Umlageverfahren Rentenbescheid Grundsicherung im Alter Rentenniveau Renteneintrittsalter Frührente Rentenformel  Generationenvertrag  Keiner der genannten
       ...
       (14, N'Umlageverfahren', -1, 'span'),
       (14, N'Rentenbescheid', -1, 'span'),
       (14, N'Grundsicherung im Alter ', -1, 'span'),
       (14, N'Rentenniveau ', -1, 'span'),
       (14, N'Renteneintrittsalter ', -1, 'span'),
       (14, N'Frührente', -1, 'span'),
       (14, N'Rentenformel', -1, 'span'),
...
--22
       ...
       (22, N'Lebensversicherung', -1, 'span'),
       (22, N'Anlagen', -1, 'span'),
